...
# В оригинале базой был pytorch_lightning.LightningModule, но для
# инференса от него нужен только nn.Module — так в сборку не тянется
# весь Lightning со своими зависимостями.
